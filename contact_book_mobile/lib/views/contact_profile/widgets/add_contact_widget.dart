...
import 'package:contact_book_mobile/views/contact_profile/data/contact_profile_services.dart';
...
class _AddContactWidgetState extends State<AddContactWidget> {
  ...
  InputDecoration getInputDecoration(String hintText) {
    return InputDecoration(
      // prefixIconConstraints: BoxConstraints(minWidth: 15, maxHeight: 15),
                          ...
                          onPressed: () async {
                            ...
                            if (resp != null) {
                              setState(() {
                                ...
                                isStreetEnable = streetInitialValue.text == ""
                                    ? true
                                    : false;
                                isDistrictEnable =
                                    districtInitialValue.text == ""
                                        ...
                                        : false;
                                isCityEnable =
                                    cityInitialValue.text == "" ? true : false;
                              });
                            }
                          }))
                ],
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextFormField(
                        ...
                        onSaved: (value) => setState(() => number = value!),
                        style: TextStyle(color: Colors.white)),
                  )
                ],
              )),
            ...
            child: ElevatedButton(
              onPressed: () async {
                ...
                if (isValid) {
                  ...
                  try {
                    resp = await ContactProfileServices()
